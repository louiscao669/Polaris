#!/usr/bin/env python3
"""Throughput and latency benchmark for single_server market reads."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run throughput/latency tests for single_server market reads."
    )
...
def run_once(args: argparse.Namespace, headers: dict[str, str], *, verbose: bool) -> tuple[int, int, float]:
    if verbose:
        print("Starting single_server market view benchmark")
        print(
            json.dumps(
                {
...
def main() -> int:
    ...
    print("Starting single_server market view benchmark sweep")
