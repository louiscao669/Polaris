...
will be triggered, and the data in the nodes will be lost, as reflected when we rerun the test functions in the fastAPI page. 
So a way is needed to log the data so that the messages are not lost
